  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-neutral">
        ...
        <p className="mb-4">
          At Distribution.Studio, we take your privacy seriously. This policy
        ...
        <p className="mb-4">
          Distribution.Studio uses third-party services for analytics and
        ...
        <p className="text-sm text-muted-foreground mt-10">
          Note: Distribution.Studio is not affiliated with Zerodha or endorsed by
          them.
        </p>
      </div>
    </div>
