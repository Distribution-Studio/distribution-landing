  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-neutral">
        ...
        <p className="mb-4">
          Welcome to Distribution.Studio. By using our website and services, you agree
        ...
        <p className="mb-4">
          By accessing or using Distribution.Studio, you acknowledge that you have
        ...
        <p className="mb-4">
          Distribution.Studio provides a platform for Zerodha users to track their
        ...
        <p className="mb-4">
          You agree not to use Distribution.Studio for any unlawful purpose or in any
        ...
        <p className="mb-4">
          Distribution.Studio is provided "as is" without warranties of any kind. We
