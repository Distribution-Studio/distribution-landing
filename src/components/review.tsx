...
export const Review = () => (
  <div className="relative rounded-xl flex flex-col justify-between border component-outline bg-card p-6 h-full">
    <p className="max-w-3xl text-balance font-semibold text-lg tracking-tight sm:text-xl">
      &ldquo; Every morning I wake up just to see the internet flooded with poorly executed insecure waitlists. These are very likely just 'vibe-coded' waitlists. As they're made by newbie devs or non technical people. &rdquo;
    </p>
    <div className="flex items-center justify-between gap-4 mt-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          <span className="font-medium">Arjun Aditya</span>, Creator of Distribution.Studio
        </p>
      </div>
